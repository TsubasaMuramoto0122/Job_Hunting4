...
#define BLAST_SCALE_MAX			(5)									// 爆発球サイズの最大値
...
public:
	...
	// オブジェクト生成
	static CBlast *Create(D3DXVECTOR3 pos, D3DXVECTOR3 size, D3DXCOLOR col, int nLine, int nVertical);

	void Spread(void);																					// 爆風広がる処理の関数
