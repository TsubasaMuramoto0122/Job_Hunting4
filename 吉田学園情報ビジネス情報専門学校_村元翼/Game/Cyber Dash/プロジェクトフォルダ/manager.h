...
public:
	...
	static CGame			*GetGame()				{ return m_pGame; }					// ゲームモードの取得

	static void SetSwitch(bool bSwitch) { m_bSwitch = bSwitch; }						// ポーズ切り替えの設定
...
private:
	...
	static bool				m_bSwitch;						// ポーズ切り替えする
